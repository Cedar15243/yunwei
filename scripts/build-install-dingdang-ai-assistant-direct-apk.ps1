...
$buildScript = Join-Path $repoRoot "scripts\build-dingdang-ai-assistant-apk.ps1"
$installScript = Join-Path $repoRoot "scripts\install-and-verify-dingdang-ai-assistant.ps1"
...
try {
  ...
  Write-Output "Building direct AI assistant APK. Key values are loaded but will not be printed."
